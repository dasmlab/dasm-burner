  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'isolation', name: 'isolation', component: () => import('src/pages/IsolationPage.vue') },
        { path: 'source-map', name: 'source-map', component: () => import('src/pages/SourceMapPage.vue') },
        { path: 'investigations/:id?', name: 'investigations', component: () => import('src/pages/InvestigationsPage.vue') },
      ],
    },
  ],
})
